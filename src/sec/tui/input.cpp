...
namespace sec::tui
{
    ...
    auto text_input::handle_key(const Term::Key &key) -> bool
    {
        ...
        case Term::Key::ArrowLeft:
            return handle_arrow_left();
        case Term::Key::ArrowRight:
            return handle_arrow_right();
        case Term::Key::Home:
            return handle_home();
        case Term::Key::End:
            return handle_end();
    ...
    auto text_input::handle_enter() -> bool
    {
        if (!buffer_.empty())
        {
    ...
    auto text_input::handle_backspace() -> bool
    {
        if (cursor_ > 0)
        {
    ...
    auto text_input::handle_delete() -> bool
    {
    ...
    auto text_input::handle_arrow_left() -> bool
    {
        if (cursor_ > 0)
        {
    ...
    auto text_input::handle_arrow_right() -> bool
    {
        if (cursor_ < static_cast<int>(buffer_.size()))
        {
    ...
    auto text_input::handle_home() -> bool
    {
        cursor_ = 0;
        return false;
    }
    ...
    auto text_input::handle_end() -> bool
    {
    ...
    auto text_input::handle_history_prev() -> bool
    {
        if (history_index_ > 0)
        {
            --history_index_;
    ...
    auto text_input::handle_history_next() -> bool
    {
    ...
    auto text_input::handle_completion() -> bool
    {
        if (!completer_) return false;
