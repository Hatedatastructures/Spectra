...
namespace sec::mitm
{
    ...
    /**
     * @brief 响应协议分类（用于 TLS 剥离检测）
     */
    enum class response_protocol : std::uint8_t
    {
        /** @brief 响应是 TLS */
        tls,
        /** @brief 响应非 TLS（明文） */
    ...
    public:
         ...
         * @param info TLS 解码结果
         */
        void observe_client_hello(std::uint32_t client_ip, std::uint32_t server_ip,
